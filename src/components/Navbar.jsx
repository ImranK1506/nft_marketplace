    ...
    <ul className={`list-none flexCenter flex-row ${isMobile && 'flex-col h-full'}`}>
      {['Explore NFTs', 'Listed NFTs', 'My NFTs'].map((item, i) => (
        <li
          ...
          ${active === item ? 'dark:text-white text-nft-black' : 'dark:text-nft-gray-3 text-nft-gray-2'}`}
        >
...
const Navbar = () => {
  ...
  return (
    <nav className="accent-red-500
    flexBetween w-full fixed z-10 p-4 flex-row border-b
